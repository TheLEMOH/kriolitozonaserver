...
export class MeasurementService {
  constructor(
    @InjectModel(Measurement) private repository: typeof Measurement,
  ) {}

  async create(dto: MeasurementDTO[]) {
  ...
  async updateBulk(items: MeasurementDTO[], experimentId: number) {
    ...
    forUpdate.forEach((item: MeasurementDTO) => {
